...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-y-auto px-4 py-8 safe-area-x safe-area-bottom supports-[min-height:100dvh]:min-h-dvh md:px-8">
      <div
